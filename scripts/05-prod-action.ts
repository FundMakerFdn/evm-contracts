...
async function main() {
  ...
  const depositFunctionSignature =
    'deposit(uint256,address,address,uint256,uint256,bytes)';
  ...
  await arbiSMA.setTargetChainMulticallHandler(
    BASE_CHAIN_ID,
    BASE_MULTICALL_HANDLER
  );
